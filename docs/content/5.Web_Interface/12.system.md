...
1. Download the latest firmware `.bin` file from the official [GitHub Releases page](https://github.com/meatpiHQ/wican-fw/releases). *(Note: The UI will display a notification banner at the bottom of the sidebar if a new version is detected).*
