...
* **VPN Status:** Shows the connection state of the built-in WireGuard VPN client (e.g., Connected, Connecting, Disabled, or Error). This is vital for securely routing telemetry data back to your home server while driving.
