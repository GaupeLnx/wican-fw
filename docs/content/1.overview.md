...
**This Forked Edition completely rewrites the automation and networking engines.** It transforms the WiCAN Pro from a simple OBD scanner into a highly intelligent, edge-computing telemetry node. If you wish to try out the WiCAN Pro forked firmware see the release [Wambs Forked Firmware Releases](https://github.com/wambs/wican-fw/releases)
